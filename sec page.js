...
function getmybirthday() {
  return (wishme.innerHTML =
    `${presentyear.value}` - `${birthyear.value}` + " " + "year");
}
...
function calculateBMR() {
  return (BMR.innerHTML =
    13.397 * Weight.value + 4.799 * Height.value - 5.677 * Age.value + 88.362);
}
